...
public class SetModelTransform(IDalamudPluginInterface pi) : FuncSubscriber<IGameObject, Vector3?, Quaternion?, Vector3?, bool, bool>(pi, Label)
{
    ...
    public const string Label = $"StarfallStudio.{nameof(SetModelTransform)}.V3";
...
{
    /// <summary> The label. </summary>
    public const string Label = $"StarfallStudio.{nameof(GetModelTransform)}.V3";
...
{
    /// <summary> The label. </summary>
    public const string Label = $"StarfallStudio.{nameof(ResetModelTransform)}.V3";
...
{
    /// <summary> The label. </summary>
    public const string Label = $"StarfallStudio.{nameof(LoadPoseFromFile)}.V3";
...
{
    /// <summary> The label. </summary>
    public const string Label = $"StarfallStudio.{nameof(LoadPoseFromJson)}.V3";
...
{
    /// <summary> The label. </summary>
    public const string Label = $"StarfallStudio.{nameof(GetPoseAsJson)}.V3";
...
{
    /// <summary> The label. </summary>
    public const string Label = $"StarfallStudio.{nameof(ResetPose)}.V3";
