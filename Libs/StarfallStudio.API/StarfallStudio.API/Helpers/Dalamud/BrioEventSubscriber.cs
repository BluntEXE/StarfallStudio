...
/// </summary>
public sealed class StarfallStudioEventSubscriber : IDisposable
{
    ...
    public StarfallStudioEventSubscriber(IDalamudPluginInterface pi, string label, params Action[] actions)
    {
        _label = label;
    ...
    ~StarfallStudioEventSubscriber()
        => Dispose();
}

/// <summary><inheritdoc cref="StarfallStudioEventSubscriber"/> </summary>
public sealed class StarfallStudioEventSubscriber<T1> : IDisposable
{
    private readonly string _label;
    private readonly IPluginLog _log;
    ...
    public StarfallStudioEventSubscriber(IDalamudPluginInterface pi, string label, params Action<T1>[] actions)
    {
        _label = label;
        _log = PluginLogHelper.GetLog(pi);
        try
    ...
    /// <summary><inheritdoc cref="StarfallStudioEventSubscriber.Enable"/> </summary>
    public void Enable()
    {
        if (_disabled && _subscriber != null)
        {
    ...
    /// <summary><inheritdoc cref="StarfallStudioEventSubscriber.Disable"/> </summary>
    public void Disable()
    {
        if (!_disabled)
        {
    ...
    /// <summary><inheritdoc cref="StarfallStudioEventSubscriber.Event"/> </summary>
...
/// <summary><inheritdoc cref="StarfallStudioEventSubscriber"/> </summary>
public sealed class StarfallStudioEventSubscriber<T1, T2> : IDisposable
{
    private readonly string _label;
    private readonly IPluginLog _log;
    ...
    public StarfallStudioEventSubscriber(IDalamudPluginInterface pi, string label, params Action<T1, T2>[] actions)
    {
        _label = label;
        _log = PluginLogHelper.GetLog(pi);
        try
...
/// <summary><inheritdoc cref="StarfallStudioEventSubscriber"/> </summary>
public sealed class StarfallStudioEventSubscriber<T1, T2, T3> : IDisposable
{
    private readonly string _label;
    private readonly IPluginLog _log;
    ...
    public StarfallStudioEventSubscriber(IDalamudPluginInterface pi, string label, params Action<T1, T2, T3>[] actions)
    {
        _label = label;
        _log = PluginLogHelper.GetLog(pi);
        try
...
/// <summary><inheritdoc cref="StarfallStudioEventSubscriber"/> </summary>
public sealed class StarfallStudioEventSubscriber<T1, T2, T3, T4> : IDisposable
{
    private readonly string _label;
    private readonly IPluginLog _log;
    ...
    public StarfallStudioEventSubscriber(IDalamudPluginInterface pi, string label, params Action<T1, T2, T3, T4>[] actions)
    {
        _label = label;
        _log = PluginLogHelper.GetLog(pi);
        try
...
/// <summary><inheritdoc cref="StarfallStudioEventSubscriber"/> </summary>
public sealed class StarfallStudioEventSubscriber<T1, T2, T3, T4, T5> : IDisposable
{
    private readonly string _label;
    private readonly IPluginLog _log;
    ...
    public StarfallStudioEventSubscriber(IDalamudPluginInterface pi, string label, params Action<T1, T2, T3, T4, T5>[] actions)
    {
        _label = label;
        _log = PluginLogHelper.GetLog(pi);
        try
