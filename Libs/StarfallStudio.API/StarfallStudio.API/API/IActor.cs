...
namespace StarfallStudio.API.Interface;
...
public interface IActor
{
    ...
    /// </summary>
    StarfallStudioApiResult LoadMCDF(IGameObject gameObject, string path);

    /// <summary>
    /// Saves the actor’s data to an MCDF file.
    /// </summary>
    StarfallStudioApiResult SaveMCDF(IGameObject gameObject, string path, string description);
}
