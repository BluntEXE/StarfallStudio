...
public class PosingConfiguration
{
    ...
    public bool ShowBoneCircles { get; set; } = true;
    ...
    // Targeting
    public bool GPoseTargetChangesWithStarfallStudio { get; set; } = false;
    public bool StarfallStudioTargetChangesWithGPose { get; set; } = true;
