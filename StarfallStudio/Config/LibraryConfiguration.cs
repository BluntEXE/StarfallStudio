...
public class LibraryConfiguration
{
    ...
    public void ReEstablishDefaultPaths()
    {
        if(Files.Count <= 0)
        {
            Files.Add(new FileSourceConfig() { Name = "StarfallStudio Poses", Path = "/StarfallStudio/Poses/", Root = Environment.SpecialFolder.MyDocuments, CanEdit = false });
            Files.Add(new FileSourceConfig() { Name = "StarfallStudio Characters", Path = "/StarfallStudio/Characters/", Root = Environment.SpecialFolder.MyDocuments, CanEdit = false });
