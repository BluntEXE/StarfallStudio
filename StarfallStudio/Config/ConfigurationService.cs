...
public class ConfigurationService : IDisposable
{
    ...
    public const string StarfallStudioRepo = "https://raw.githubusercontent.com/etheirys/brio/main/repo.json";
    ...
    public static readonly string s_version = typeof(StarfallStudio).Assembly.GetName().Version?.ToString() ?? "(Unknown Version)";
