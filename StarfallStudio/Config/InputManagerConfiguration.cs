...
public class InputManagerConfiguration
{
    ...
    {
        { InputAction.Interface_ToggleStarfallStudioWindow, new KeyConfig(VirtualKey.B, false, true, false) },
        ...
        { InputAction.StarfallStudio_Alt, new KeyConfig(VirtualKey.MENU) },
        { InputAction.StarfallStudio_Ctrl, new KeyConfig(VirtualKey.CONTROL) },
        { InputAction.StarfallStudio_Shift, new KeyConfig(VirtualKey.SHIFT) }
    };
