...
using StarfallStudio.Files.Converters;
...
public class PoseFileInfo : AppliableActorFileInfoBase<PoseFile>
{
    ...
    {
        if(ImStarfallStudio.Button("##pose_import_options_action", FontAwesomeIcon.Cog, new Vector2(25, 0), tooltip: "Import Options"))
        {
...
{
    public string TypeName { get; set; } = "StarfallStudio Pose";
