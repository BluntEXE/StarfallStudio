...
public class AnamnesisCharaFileInfo(EntityManager entityManager, ConfigurationService configurationService) : AppliableActorFileInfoBase<AnamnesisCharaFile>(entityManager, configurationService)
{
    ...
    {
        StarfallStudio.Log.Debug($"Name: {Name} | File: {file}");
...
public class AnamnesisCharaFile : JsonDocumentBase
{
    ...
    public static implicit operator StarfallStudioHuman.ShaderParams(AnamnesisCharaFile chara)
    {       
        // More Extended Appearance (Shaders)
        var shaders = new StarfallStudioHuman.ShaderParams
        {
