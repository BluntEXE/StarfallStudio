...
using StarfallStudio.UI.Widgets.Posing;
...
namespace StarfallStudio.Capabilities.Posing;
...
public class PosingCapability : ActorCharacterCapability
{
    ...
    public void ImportPose(string path, PoseImporterOptions? options = null)
    {
        ...
        {
            StarfallStudio.NotifyError("Invalid pose file.");
        }
    }
        ...
        bool freezeOnLoad = false, bool asProp = false, TransformComponents? transformComponents = null, bool? applyModelTransformOverride = null)
    {
        ...
        {
            StarfallStudio.Log.Verbose($"Importing Pose... {asExpression} {asScene} {asIPCpose} {asBody} {freezeOnLoad}");
        ...
        {
            StarfallStudio.Log.Warning($"Actor did not have ActionTimelineCapability while Importing a Pose... {asExpression} {asScene} {asIPCpose} {asBody} {freezeOnLoad}");
        }
    }
        ...
        TransformComponents? transformComponents = null, bool? applyModelTransformOverride = null)
    {
        ...
        {
            StarfallStudio.NotifyError("Invalid pose file.");
            StarfallStudio.Log.Info($"Invalid pose file. {reconcile} {reset} {generateSnapshot} {asExpression} {expressionPhase2} {asScene} {asIPCpose} {asBody}");
            return;
        }
        ...
        if(asExpression)
        {
            StarfallStudio.Log.Debug("Loading as Expression");
