...
namespace StarfallStudio.UI.Widgets.Core;
    ...
    public static void DrawBody(IWidget? widget)
    {
        ...
        using(ImRaii.PushId(widget.GetType().Name))
        {
            ...
            if(widget.Flags.HasFlag(WidgetFlags.HasAdvanced))
            {
                ...
                if(ImStarfallStudio.FontIconButtonRight("advanced", FontAwesomeIcon.SquareArrowUpRight, 1, tool, bordered: false, size: new Vector2(23)))
