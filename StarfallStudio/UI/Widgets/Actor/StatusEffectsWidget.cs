...
public class StatusEffectsWidget(StatusEffectCapability capability) : Widget<StatusEffectCapability>(capability)
{
    ...
    public override void DrawBody()
    {
        ...
        if(ImStarfallStudio.FontIconButton("status_effects_add", FontAwesomeIcon.Plus, "Add Effect", canAdd))
            ApplyStatusEffect();

        ImGui.SameLine();

        if(ImStarfallStudio.FontIconButton("status_effects_remove", FontAwesomeIcon.Minus, "Remove Effect", isSelectedPlaying))
        ...
        if(ImStarfallStudio.FontIconButton("status_effects_search", FontAwesomeIcon.Search, "Search"))
        {
