...
public class CameraContainerWidget(CameraContainerCapability capability) : Widget<CameraContainerCapability>(capability)
{
    ...
    public override void DrawQuickIcons()
    {
        using(ImRaii.Disabled(Capability.IsAllowed == false))
        {
            ...
            if(ImStarfallStudio.FontIconButton("CameraContainerWidget_New_Camera", FontAwesomeIcon.Plus, "New Camera"))
            {
            ...
            using(ImRaii.Disabled(hasSelection == false))
            {
                ...
                {
                    if(ImStarfallStudio.FontIconButton("CameraLifetime_destroy", FontAwesomeIcon.Trash, "Destroy Camera"))
                    {
                ...
                if(ImStarfallStudio.FontIconButton("CameraLifetime_target", FontAwesomeIcon.LocationCrosshairs, "Target Camera"))
                {
