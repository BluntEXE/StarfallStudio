...
public class FestivalWidget : Widget<FestivalCapability>
{
    ...
    private void DrawControls()
    {
        ...
        using(ImRaii.Disabled(!Capability.CanModify))
        {
            ...
            if(ImStarfallStudio.FontIconButton("festival_add_button", FontAwesomeIcon.Plus, "Add Festival", Capability.CanAdd && _selectedFestival != 0))
            {
                AddFestival();
            }
            ...
            if(ImStarfallStudio.FontIconButton("festival_remove_button", FontAwesomeIcon.Minus, "Remove Festival", _selectedFestival != 0 && festivals.Contains((uint)_selectedFestival)))
            {
            ...
            if(ImStarfallStudio.FontIconButton("festival_reset_button", FontAwesomeIcon.Redo, "Reset", Capability.HasOverride))
            {
                Capability.Reset();
            }
            ...
            if(ImStarfallStudio.FontIconButton("festival_search_button", FontAwesomeIcon.Search, "Search", Capability.CanAdd))
            {
