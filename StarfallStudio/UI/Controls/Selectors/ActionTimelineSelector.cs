...
namespace StarfallStudio.UI.Controls.Selectors;
...
public class ActionTimelineSelector(string id) : Selector<ActionTimelineSelectorEntry>(id)
{
    ...
    private void DrawPinButton()
    {
        ...
        if(ImStarfallStudio.FontIconButton($"pin_toggle_{_id}", pinIcon, tooltip, true, true, pinColor))
        {
            TogglePin();
        }
    ...
    protected override void PopulateList()
    {
        ...
        {
            StarfallStudioActionTimeline timeline;
    ...
    protected override void DrawItem(ActionTimelineSelectorEntry item, bool isSoftSelected)
    {
        ...
        ImStarfallStudio.BorderedGameIcon("icon", item.Icon, "Images.ActionTimeline.png", description, flags: ImGuiButtonFlags.None, size: IconSize);
    }
    ...
    protected override void DrawOptions()
    {
        ...
        var changed = ImStarfallStudio.ToggleSelecterStrip("actiontimeline_filters_selector", Vector2.Zero, ref items, ["Emotes", "Actions", "Timelines"]);
        ...
        if(!_showBlendable)
        {
            ...
            if(ImStarfallStudio.ButtonSelectorStrip("draws_weapon_filter", Vector2.Zero, ref drawsWeaponSelection, ["All", "Sheathed", "Drawn"]))
            {
        ...
        if(ImStarfallStudio.ButtonSelectorStrip("emote_category_filter", Vector2.Zero, ref emoteCategorySelection, ["All", "General", "Special", "Expressions"]))
        {
