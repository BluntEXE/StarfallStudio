...
using static StarfallStudio.UI.Controls.Selectors.NpcSelector;
...
public class NpcSelector(string id) : Selector<NpcSelectorEntry>(id)
{
    ...
    protected override void DrawItem(NpcSelectorEntry item, bool isHovered)
    {
        ...
        ImStarfallStudio.BorderedGameIcon("icon", item.Icon, "Images.UnknownIcon.png", flags: ImGuiButtonFlags.None, size: IconSize);
        ImGui.SameLine();
