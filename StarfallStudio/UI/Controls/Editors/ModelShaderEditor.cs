...
public class ModelShaderEditor()
{
    ...
    public bool Draw(StarfallStudioHuman.ShaderParams original, ref ModelShaderOverride apply, ActorAppearanceCapability capability)
    {
    ...
    private bool DrawReset(StarfallStudioHuman.ShaderParams original, ref ModelShaderOverride apply)
    {
        var resetTo = ImGui.GetCursorPos();
        bool shaderChange = apply.HasOverride;
        if(ImStarfallStudio.FontIconButtonRight("reset_shaders", FontAwesomeIcon.Undo, 1, "Reset Shaders", shaderChange))
        {
            apply.Reset();
    ...
    private unsafe bool DrawMuscleTone(StarfallStudioHuman.ShaderParams original, ref ModelShaderOverride apply)
    {
        bool didChange = false;
    ...
    private bool DrawBodyColors(StarfallStudioHuman.ShaderParams original, ref ModelShaderOverride apply)
    {
        bool didChange = false;
    ...
    private bool DrawOtherColors(StarfallStudioHuman.ShaderParams original, ref ModelShaderOverride apply)
    {
        bool didChange = false;
    ...
    private bool DrawHairColors(StarfallStudioHuman.ShaderParams original, ref ModelShaderOverride apply)
    {
