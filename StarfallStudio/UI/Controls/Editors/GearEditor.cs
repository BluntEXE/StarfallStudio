...
public class GearEditor()
{
    ...
    public bool DrawGear(ref ActorAppearance currentAppearance, ActorAppearance originalAppearance, ActorAppearanceCapability capability)
    {
        ...
        if(ImStarfallStudio.FontIconButton("erase_equipment", FontAwesomeIcon.Eraser, "Remove all Equipment"))
        {
            _capability.RemoveAllEquipment();
        }

        ImGui.SameLine();
        if(ImStarfallStudio.FontIconButton("apply_smallclothes", FontAwesomeIcon.UserShield, "Equip NPC Smallclothes"))
        {
            _capability.ApplySmallclothes();
        }

        ImGui.SameLine();
        if(ImStarfallStudio.FontIconButton("apply_emperors", FontAwesomeIcon.UserNinja, "Equip Emperor's Set"))
        {
            _capability.ApplyEmperors();
        }

        ImGui.SameLine();
        if(ImStarfallStudio.FontIconButton("apply_invisibleclothes", FontAwesomeIcon.LowVision, "Equip Invisible Clothes"))
        {
            ...
            {
                {
                    ...
                    if(ImStarfallStudio.DrawLabeledColor("dye0", dye0Color, dye0Id.ToString(), $"{dye0Name} ({dye0Id})"))
                    {
                    ...
                    if(ImStarfallStudio.DrawLabeledColor("dye1", dye1Color, dye1Id.ToString(), $"{dye1Name} ({dye1Id})"))
                    {
                    ...
                    if(slot == ActorEquipSlot.Head)
                    {
                        ...
                        if(ImStarfallStudio.FontIconButton("hidehat", isHidden ? FontAwesomeIcon.Eye : FontAwesomeIcon.EyeSlash, isHidden ? "Show" : "Hide", bordered: false))
                        {
                        ...
                        if(ImStarfallStudio.FontIconButton("visor", FontAwesomeIcon.Mask, "Visor", bordered: false, textColor: isToggled ? 0xFF555555 : null))
                        {
                        ...
                        if(ImStarfallStudio.FontIconButton("ears", FontAwesomeIcon.Deaf, "Viera Ears Hidden", bordered: false, textColor: IsEars ? 0xFF555555 : null))
                        {
                    ...
                    using(var gearPopup = ImRaii.Popup("gear_popup"))
                    {
                        if(gearPopup.Success)
                        {
                            ...
                            if(ImStarfallStudio.FontIconButton("erase_equipment_popup", FontAwesomeIcon.Eraser, "Remove Equipment"))
                            {
                            ...
                            ImGui.SameLine();
                            if(ImStarfallStudio.FontIconButton("apply_smallclothes_popup", FontAwesomeIcon.UserShield, "Equip NPC Smallclothes"))
                            {
                            ...
                            ImGui.SameLine();
                            if(ImStarfallStudio.FontIconButton("apply_emperors_popup", FontAwesomeIcon.UserNinja, "Equip Emperor's Set"))
                            {
            ...
            {
                {
                    ...
                    if(ImStarfallStudio.FontIconButton("hideweap", isHidden ? FontAwesomeIcon.Eye : FontAwesomeIcon.EyeSlash, isHidden ? "Show" : "Hide", bordered: false))
                    {
                    ...
                    {
                        ImGui.SameLine();
                        if(ImStarfallStudio.FontIconButton("attachweapon", FontAwesomeIcon.FistRaised, "Attach Weapon", bordered: false))
                        {
    ...
    private bool DrawFacewearSlot(ref ActorAppearance appearance)
    {
        ...
        using(ImRaii.PushId("facewear"))
        {
            ...
            if(ImStarfallStudio.BorderedGameIcon("##icon", facewearIcon, "Images.Facewear.png", size: faceIconSize))
            {
