...
public class UIManager : IDisposable
{
        ...
        )
    {
        ...
        _windowSystem = new(StarfallStudio.Name);
    ...
    {
        if(_configurationService.Configuration.Interface.OpenStarfallStudioBehavior == OpenStarfallStudioBehavior.OnGPoseEnter)
            _mainWindow.IsOpen = newState;
    }

    private void ApplySettings()
    {
        StarfallStudioStyle.EnableStyle = _configurationService.Configuration.Appearance.EnableStarfallStudioStyle;
    ...
    private void DrawUI()
    {
        ...
        {
            StarfallStudioStyle.PopStyle();
        }
    }

    private void UpdateKeyBinds()
    {
        if(InputManagerService.ActionKeysPressedLastFrame(InputAction.Interface_ToggleStarfallStudioWindow))
        {
