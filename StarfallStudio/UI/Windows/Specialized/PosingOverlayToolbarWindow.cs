...
public class PosingOverlayToolbarWindow : Window
{
    ...
    public override void Draw()
    {
        ...
        else
        {
            ...
            ImStarfallStudio.AttachToolTip("Toggle Transform Window");
            ...
            ImStarfallStudio.AttachToolTip("Toggle Light Window");
            ...
            ImStarfallStudio.AttachToolTip("Close Overlay");
    ...
    public void DrawLightButtons(LightTransformCapability? lightTransformCapability)
    {
        ...
        ImStarfallStudio.AttachToolTip(_lightingService.CoordinateMode == LightGizmoCoordinateMode.Local ? "Switch to World" : "Switch to Local");
        ...
        ImStarfallStudio.AttachToolTip("Position");
        ...
        ImStarfallStudio.AttachToolTip("Rotation");
        ...
        ImStarfallStudio.AttachToolTip("Universal");
        //
        // -------------
        //
        ...
        ImStarfallStudio.AttachToolTip("Undo last Light Action");
        ...
        ImStarfallStudio.AttachToolTip("Redo last Light Action");
        ...
        ImStarfallStudio.AttachToolTip("Reset Light Transform");
        ...
        using(ImRaii.Disabled(true))
        {
            ...
            ImStarfallStudio.AttachToolTip("Load Light from Clipboard");
            ...
            ImStarfallStudio.AttachToolTip("Save Light to Clipboard");
        }
    ...
    private void DrawButtons(PosingCapability? posing, ActionTimelineCapability? timelineCapability, bool hasMultipleActorsSelected)
    {
        ...
        ImStarfallStudio.AttachToolTip(_posingService.CoordinateMode == PosingCoordinateMode.Local ? "Switch to World" : "Switch to Local");
        ...
        ImStarfallStudio.AttachToolTip("Scale");
        ...
        using(ImRaii.Disabled(posing is null))
        {
            ...
            if(posing?.Selected.Value is BonePoseInfoId boneId)
            {
                ...
                enabled = ik.Enabled && StarfallStudioStyle.EnableStyle;
            }
            ...
            ImStarfallStudio.AttachToolTip("Inverse Kinematics");
            ...
            ImStarfallStudio.AttachToolTip("Bone Filter");
            ...
            using(ImRaii.Disabled(posing?.SkeletonPosing.PoseInfo.HasIKStacks is false))
            {
                ...
                ImStarfallStudio.AttachToolTip($"Set IK Changes{(!posing?.SkeletonPosing.PoseInfo.HasIKStacks ?? false ? ". Enable IK & make a change with IK to 'Lock in' IK changes using this button." : "")}");
            ...
            ImStarfallStudio.AttachToolTip("Bone Search");
            ...
            ImStarfallStudio.AttachToolTip("Clear Selection");
            ...
            ImStarfallStudio.AttachToolTip($"{(allFrozen ? "Un-" : "")}Freeze Character{(hasMultipleActorsSelected ? "s" : "")}");
        ...
        ImStarfallStudio.AttachToolTip("Undo");
        ...
        ImStarfallStudio.AttachToolTip("Redo");
        ...
        ImStarfallStudio.AttachToolTip("Reset Bone");
        ...
        ImStarfallStudio.AttachToolTip("Mirror Pose");
        ...
        ImStarfallStudio.AttachToolTip("Reset Body");
        ...
        ImStarfallStudio.AttachToolTip("Reset Face");
        ...
        ImStarfallStudio.AttachToolTip("Reset Pose");
        ...
        ImStarfallStudio.AttachToolTip("Import Pose");
        ...
        ImStarfallStudio.AttachToolTip("Save Pose");
