...
namespace StarfallStudio.Game.Posing.Skeletons;
...
public class Skeleton : IDisposable
{
    ...
    public unsafe StarfallStudioCharacterBase* CharacterBase => (StarfallStudioCharacterBase*)GameSkeleton->Owner;
    ...
    public unsafe static Skeleton? Create(StarfallStudioCharacterBase* charaBase)
    {
        if(charaBase == null)
            return null;
