...
public class PoseInfo
{
    ...
    public void Clear(Predicate<BonePoseInfoId>? predicate = null)
    {
        foreach(var pose in _poses)
        {
            ...
            {
                StarfallStudio.Log.Debug($"Clearing stacks for pose {pose.Key}");
