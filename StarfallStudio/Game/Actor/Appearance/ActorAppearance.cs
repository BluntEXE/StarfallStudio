...
namespace StarfallStudio.Game.Actor.Appearance;
...
public struct ActorAppearance()
{
    ...
    public unsafe static ActorAppearance FromCharacter(DalamudCharacter character)
    {
        ...
        actorAppearance.Facewear = native->DrawData.GlassesIds[0]; //character.StarfallStudioDrawData()->Facewear;
...
public struct ActorAppearanceExtended
{
    ...
    public StarfallStudioHuman.ShaderParams? ShaderParams;
}
