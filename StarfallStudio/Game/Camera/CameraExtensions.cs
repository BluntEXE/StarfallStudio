...
{
    public unsafe static Matrix4x4 GetProjectionMatrix(this StarfallStudioCamera camera)
    {
    ...
    public unsafe static Matrix4x4 GetViewMatrix(this StarfallStudioCamera camera)
    {
    ...
    public unsafe static bool WorldToScreen(this StarfallStudioCamera camera, Vector3 world, out Vector2 screen)
    {
    ...
    public unsafe static bool ScreenToWorld(this StarfallStudioCamera camera, Vector2 screen, out Vector3 world)
    {
    ...
    public unsafe static Vector3 GetPosition(this StarfallStudioCamera camera)
    {
    ...
    public unsafe static float GetFoV(this StarfallStudioCamera camera)
    {
