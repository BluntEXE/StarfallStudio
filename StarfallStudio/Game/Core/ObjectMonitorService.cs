...
public unsafe class ObjectMonitorService : IDisposable
{
    ...
    public delegate void CharacterBaseEventDelegate(StarfallStudioCharacterBase* charaBase);
    ...
    private delegate nint CharacterBaseUpdateMaterialsDelegate(StarfallStudioCharacterBase* charaBase);
    private readonly Hook<CharacterBaseUpdateMaterialsDelegate> _characterBaseUpdateMaterialsHook = null!;

    private delegate nint CharacterBaseCleanupDelegate(StarfallStudioCharacterBase* charaBase);
