...
public static class FrameworkExtensions
{
    ...
    private static void ProcessTask<T>(IFramework framework, DeferredTask<T> task)
    {
        ...
        {
            StarfallStudio.Log.Warning(ex, $"Exception running condition action. {task}");
        ...
        else
        {
            ...
            {
                StarfallStudio.Log.Warning($"Task timed out. {task}");
    ...
    private static void CompleteTask<T>(DeferredTask<T> task, bool success, Exception? e)
    {
        ...
        {
            StarfallStudio.Log.Warning(ex, $"Exception running completion action. {task}");
