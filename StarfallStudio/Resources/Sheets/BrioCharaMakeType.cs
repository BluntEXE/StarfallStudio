...
public unsafe struct StarfallStudioCharaMakeType(ExcelPage page, uint offset, uint row) : IExcelRow<StarfallStudioCharaMakeType>
{
...
#pragma warning restore CS9113 // Parameter is unread.
    ...
    static StarfallStudioCharaMakeType IExcelRow<StarfallStudioCharaMakeType>.Create(ExcelPage page, uint offset, uint row) =>
        new(page, offset, row);
    ...
    public static MenuCollection BuildMenus(ActorAppearance appearance)
    {
        ...
        var CharaMakeTypes = GameDataProvider.Instance.DataManager.GetExcelSheet<StarfallStudioCharaMakeType>(name: "CharaMakeType").
