...
namespace StarfallStudio.Resources.Sheets;

[Sheet("HairMakeType")]
public struct StarfallStudioHairMakeType(ExcelPage page, uint offset, uint row) : IExcelRow<StarfallStudioHairMakeType>
{
    ...
    public static StarfallStudioHairMakeType Create(ExcelPage page, uint offset, uint row)
    {
        var brioHairMakeType = new StarfallStudioHairMakeType(page, offset, row)
        {
    ...
    {
        var HairMakeType = GameDataProvider.Instance.DataManager.GetExcelSheet<StarfallStudioHairMakeType>().Where(x => x.Gender == customize.Gender && x.Race.RowId == (uint)customize.Race && x.Tribe.RowId == (uint)customize.Tribe);
    ...
    {
        var FacePaints = GameDataProvider.Instance.DataManager.GetExcelSheet<StarfallStudioHairMakeType>().Where(x => x.Gender == customize.Gender && x.Race.RowId == (uint)customize.Race && x.Tribe.RowId == (uint)customize.Tribe);
