...
readonly public struct StarfallStudioActionTimeline(ExcelPage page, uint offset, uint row) : IExcelRow<StarfallStudioActionTimeline>
{
    ...
    static StarfallStudioActionTimeline IExcelRow<StarfallStudioActionTimeline>.Create(ExcelPage page, uint offset, uint row) =>
        new(page, offset, row);
}
